...
export default function CollectPage() {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const prompt = `You are an expert in waste management and recycling. Analyze this image and determine if it contains any electronic waste (e-waste).  
...
Return "verificationPassed": true if no e-waste is detected.`;
